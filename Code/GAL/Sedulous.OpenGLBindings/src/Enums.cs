...
namespace Sedulous.OpenGLBindings
{
    ...
    public enum ProgramInterface : int32
    {
        TransformFeedbackBuffer = ((int32)0x8C8E),
        AtomicCounterBuffer = ((int32)0x92C0),
        Uniform = ((int32)0x92E1),
        UniformBlock = ((int32)0x92E2),
        ProgramInput = ((int32)0x92E3),
        ProgramOutput = ((int32)0x92E4),
        BufferVariable = ((int32)0x92E5),
        ShaderStorageBlock = ((int32)0x92E6),
        VertexSubroutine = ((int32)0x92E8),
        TessControlSubroutine = ((int32)0x92E9),
        TessEvaluationSubroutine = ((int32)0x92EA),
        GeometrySubroutine = ((int32)0x92EB),
        FragmentSubroutine = ((int32)0x92EC),
        ComputeSubroutine = ((int32)0x92ED),
        VertexSubroutineUniform = ((int32)0x92EE),
        TessControlSubroutineUniform = ((int32)0x92EF),
        TessEvaluationSubroutineUniform = ((int32)0x92F0),
        GeometrySubroutineUniform = ((int32)0x92F1),
        FragmentSubroutineUniform = ((int32)0x92F2),
        ComputeSubroutineUniform = ((int32)0x92F3),
        TransformFeedbackVarying = ((int32)0x92F4),
    }

    public enum ProgramInterfaceParameterName : int32
    {
    ...
    {
        ReadOnly = ((int32)0x88B8),
        WriteOnly = ((int32)0x88B9),
        ReadWrite = ((int32)0x88BA),
    }
    ...
    public enum MemoryBarrierFlags : int32
    {
    ...
    // [Flags]
    public enum BufferAccessMask : int32
    {
        Read = ((int32)0x0001),
        Write = ((int32)0x0002),
        InvalidateRange = ((int32)0x0004),
        InvalidateBuffer = ((int32)0x0008),
        FlushExplicit = ((int32)0x0010),
        Unsynchronized = ((int32)0x0020),
        Persistent = ((int32)0x0040),
        Coherent = ((int32)0x0080),
    }
    ...
    public enum ActiveUniformBlockParameter : int32
    {
        UniformBlockReferencedByTessControlShader = ((int32)0x84F0),
        UniformBlockReferencedByTessEvaluationShader = ((int32)0x84F1),
        UniformBlockBinding = ((int32)0x8A3F),
        UniformBlockDataSize = ((int32)0x8A40),
        UniformBlockNameLength = ((int32)0x8A41),
        UniformBlockActiveUniforms = ((int32)0x8A42),
        UniformBlockActiveUniformIndices = ((int32)0x8A43),
        UniformBlockReferencedByVertexShader = ((int32)0x8A44),
        UniformBlockReferencedByGeometryShader = ((int32)0x8A45),
        UniformBlockReferencedByFragmentShader = ((int32)0x8A46),
        UniformBlockReferencedByComputeShader = ((int32)0x90EC),
    }
    ...
    public enum GetTextureParameter : int32
    {
        ...
        TextureViewMinLevel = ((int32)0x82DB),
        TextureViewNumLevels = ((int32)0x82DC),
        TextureViewMinLayer = ((int32)0x82DD),
        TextureViewNumLayers = ((int32)0x82DE),
        ...
        TextureCompressedImageSize = ((int32)0x86A0),
        TextureCompressed = ((int32)0x86A1),
        TextureDepthSize = ((int32)0x884A),
        DepthTextureMode = ((int32)0x884B),
        TextureCompareMode = ((int32)0x884C),
        TextureCompareFunc = ((int32)0x884D),
        TextureStencilSize = ((int32)0x88F1),
        TextureRedType = ((int32)0x8C10),
        TextureGreenType = ((int32)0x8C11),
        TextureBlueType = ((int32)0x8C12),
        TextureAlphaType = ((int32)0x8C13),
        TextureLuminanceType = ((int32)0x8C14),
        TextureIntensityType = ((int32)0x8C15),
        TextureDepthType = ((int32)0x8C16),
        TextureSharedSize = ((int32)0x8C3F),
        TextureSwizzleR = ((int32)0x8E42),
        TextureSwizzleG = ((int32)0x8E43),
        TextureSwizzleB = ((int32)0x8E44),
        TextureSwizzleA = ((int32)0x8E45),
        TextureSwizzleRgba = ((int32)0x8E46),
        ImageFormatCompatibilityType = ((int32)0x90C7),
        TextureSamples = ((int32)0x9106),
        TextureFixedSampleLocations = ((int32)0x9107),
        TextureImmutableFormat = ((int32)0x912F),
    }
