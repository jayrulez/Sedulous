...
namespace Sedulous.MetalBindings
{
    public struct NSError
    {
		...
		public void domain(String str) => string_objc_msgSend(NativePtr, "domain", str);
		public void localizedDescription(String str) => string_objc_msgSend(NativePtr, "localizedDescription", str);
    }
}