...
/// <summary>
/// Represents the engine's timing state.
/// </summary>
class EngineTime
{
	/// <summary>
	/// Initializes a new instance of the <see cref="EngineTime"/> class.
	/// </summary>
	public this()
	{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="EngineTime"/> class with the specified elapsed and total times.
	/// </summary>
