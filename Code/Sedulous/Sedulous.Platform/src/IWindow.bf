...
{
	/// <summary>
	/// Represents the method that is called when an  window raises an event.
	/// </summary>
	/// <param name="window">The window that raised the event.</param>
	public delegate void WindowEventHandler(IWindow window);

	/// <summary>
	/// Represents the method that is called when an  window is drawn.
	/// </summary>
	/// <param name="window">The window that raised the event.</param>
	/// <param name="time">Time elapsed since the last call to <see cref="Context.Draw(Time)"/>.</param>
	public delegate void WindowDrawingEventHandler(IWindow window, Time time);

	/// <summary>
	/// Represents a window that is attached to an  context.
	/// </summary>
	public interface IWindow
	{
		...
		/// </summary>
		bool GrabsMouseWhenFullscreenWindowed
		{
			get;
			set;
		}
		...
		/// </summary>
		EventAccessor<WindowDrawingEventHandler> DrawingUI { get; }
	}
}
