...
using internal Sedulous.Platform.Input;
...
namespace Sedulous.Platform.Input
{
    ...
    public abstract class TouchDevice : InputDevice
    {
        ...
        public abstract void BindToWindow(IWindow window);
        ...
        /// </summary>
        public abstract IWindow BoundWindow { get; }
        ...
        /// </summary>
        public readonly EventAccessor<TouchDownEventHandler> TouchDown {get;} = new .() ~ delete _; 

        /// <summary>
        /// Occurs when a touch input ends.
        /// </summary>
        public readonly EventAccessor<TouchUpEventHandler> TouchUp {get;} = new .() ~ delete _; 

        /// <summary>
        /// Occurs when a touch input moves.
        /// </summary>
        public readonly EventAccessor<TouchMotionEventHandler> TouchMotion {get;} = new .() ~ delete _; 

        /// <summary>
        /// Occurs when a touch input is interpreted as a tap.
        /// </summary>
        public readonly EventAccessor<TouchTapEventHandler> Tap {get;} = new .() ~ delete _; 

        /// <summary>
        /// Occurs when a touch input becomes a long press.
        /// </summary>
        public readonly EventAccessor<TouchLongPressEventHandler> LongPress {get;} = new .() ~ delete _; 

        /// <summary>
        /// Occurs when a multiple-finger touch gesture is performed.
        /// </summary>
        public readonly EventAccessor<MultiGestureEventHandler> MultiGesture {get;} = new .() ~ delete _; 

        /// <summary>
        /// Occurs when a $1 gesture is recorded.
        /// </summary>
        public readonly EventAccessor<DollarGestureRecordedEventHandler> DollarGestureRecorded {get;} = new .() ~ delete _; 

        /// <summary>
        /// Occurs when a $1 gesture is performed.
        /// </summary>
        public readonly EventAccessor<DollarGestureEventHandler> DollarGesture {get;} = new .() ~ delete _; 
