...
namespace Sedulous.Foundation.Mathematics
{
    ...
    /// </summary>
    //[Serializable]
    public struct BoundingBox : IEquatable<BoundingBox>, IEquatable, IHashable
    {
        /// <summary>
        ...
        public static BoundingBox CreateFromPoints(IEnumerator<Vector3> points)
        {
        ...
        public static void CreateFromPoints(IEnumerator<Vector3> points, out BoundingBox result)
        {
        ...
        {
			var sphere;
            CreateFromSphere(ref sphere, var result);
            return result;
        }
        ...
        /// <inheritdoc/>
        public override void ToString(String outStr) => outStr.Append(scope $"{{Min:{Min} Max:{Max}}}");
        ...
        public void GetCorner(int index, out Vector3 result)
        {
            switch (index)
            {
                ...
                default:
                    Runtime.FatalError(scope $"Argument out of range: {nameof(index)}");
            }
        }
        ...
        public void GetCorners(Vector3[] corners)
        {
            ...
            Contract.Ensure(corners.Count >= CornerCount, nameof(corners));
        ...
        public void Contains(ref BoundingSphere sphere, out ContainmentType result)
        {
			var Min = Min;
			var Max = Max;
            Vector3.Clamp(ref sphere.Center, ref Min, ref Max, var clampedCenter);
            Vector3.DistanceSquared(ref sphere.Center, ref clampedCenter, var clampedCenterOffset);
        ...
        {
			var self = this;
            plane.Intersects(ref self, var result);
            return result;
        }
