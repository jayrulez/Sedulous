...
namespace Sedulous.Foundation.Mathematics
{
    ...
    /// </summary>
    //[Serializable]
    public struct Plane : IEquatable<Plane>, IEquatable, IHashable, IInterpolatable<Plane>
    {
        /// <summary>
        ...
        /// <param name="value">The vector for which to calculate the dot product.</param>
        /// <param name="result">The dot product of the specified plane and vector.</param>
        public static void DotNormal(ref Plane plane, ref Vector4 value, out float result)
        {
            result = 
                plane.Normal.X * value.X +
                plane.Normal.Y * value.Y +
        ...
        /// <inheritdoc/>
        public override void ToString(String outStr) => outStr.Append(scope $"{{Normal:{Normal} D:{D}}}");
        ...
        {
			var self = this;
            sphere.Intersects(ref self, var result);
            return result;
        }
        ...
        {
			var self = this;
            sphere.Intersects(ref self, out result);
        }
        ...
        {
			var self = this;
            @box.Intersects(ref self, var result);
            return result;
        }
