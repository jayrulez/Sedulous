...
namespace Sedulous.Foundation.Mathematics
{
    ...
    public static class Tweening
    {
        ...
        static this()
        {
            Interpolators.Register<Object>(new =>Tween);
            Interpolators.Register<bool>(new =>Tween);
            Interpolators.Register<uint8>(new =>Tween);
            Interpolators.Register<int8>(new =>Tween);
            Interpolators.Register<char8>(new =>Tween);
            Interpolators.Register<int16>(new =>Tween);
            Interpolators.Register<int32>(new =>Tween);
            Interpolators.Register<int64>(new =>Tween);
            Interpolators.Register<uint16>(new =>Tween);
            Interpolators.Register<uint32>(new =>Tween);
            Interpolators.Register<uint64>(new =>Tween);
            Interpolators.Register<float>(new =>Tween);
            Interpolators.Register<double>(new =>Tween);
        ...
        public static char8 Tween(char8 tweenStart, char8 tweenEnd, EasingFunction fn, float t)
        {
            ...
            var delta = (tweenEnd - tweenStart);
            return (char8)((float)tweenStart + (delta * (fn ?? Easings.EaseInLinear)(t)));
        }
        ...
        public static char8 Lerp(char8 lerpStart, char8 lerpEnd, float t)
        {
            ...
            var delta = (lerpEnd - lerpStart);
            return (char8)((float)lerpStart + (delta * t));
        }
        ...
        /// <param name="t">A value between 0.0 and 1.0 indicating the current position in the tween.</param>
        /// <returns>A value which is interpolated from the specified start and end values.</returns>
        public static T Tween<T>(T tweenStart, T tweenEnd, EasingFunction fn, float t)
        {
        ...
        /// <param name="t">A value between 0.0 and 1.0 indicating the current position in the interpolation.</param>
        /// <returns>A value which is interpolated from the specified start and end values.</returns>
        public static T Lerp<T>(T lerpStart, T lerpEnd, float t)
        {
            Interpolator<T> interpolator;
            if (!Interpolators.TryGet<T>(out interpolator) || interpolator == null)
            {
        ...
        /// <param name="t">A value between 0.0 and 1.0 indicating the current position in the tween.</param>
        /// <returns>A value which is interpolated from the specified start and end values.</returns>
        public static T TweenRef<T>(ref T tweenStart, ref T tweenEnd, EasingFunction fn, float t) where T : struct
        {
            Interpolator<T> interpolator;
            if (!Interpolators.TryGet<T>(out interpolator) || interpolator == null)
            {
        ...
        /// <param name="t">A value between 0.0 and 1.0 indicating the current position in the interpolation.</param>
        /// <returns>A value which is interpolated from the specified start and end values.</returns>
        public static T LerpRef<T>(ref T lerpStart, ref T lerpEnd, float t) where T : struct
        {
            Interpolator<T> interpolator;
            if (!Interpolators.TryGet<T>(out interpolator) || interpolator == null)
            {
