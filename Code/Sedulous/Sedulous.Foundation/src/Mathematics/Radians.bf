...
namespace Sedulous.Foundation.Mathematics
{
    ...
    /// </summary>
    public struct Radians : IEquatable<Radians>, IEquatable, IHashable, IInterpolatable<Radians>
    {
        /// <summary>
		...
		public static int operator<=>(Self lhs, float value) => lhs.CompareTo(value);
