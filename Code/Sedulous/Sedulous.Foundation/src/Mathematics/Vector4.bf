...
namespace Sedulous.Foundation.Mathematics
{
    ...
    /// </summary>
    //[Serializable]
    public struct Vector4 : IEquatable<Vector4>, IEquatable, IHashable, IInterpolatable<Vector4>
    {
        /// <summary>
        ...
        /// <param name="factor">The scaling factor by which to multiply the vector.</param>
        /// <param name="result">The resulting <see cref="Vector4"/>.</param>
        public static void Multiply(ref Vector4 vector, float factor, out Vector4 result)
        {
            result.X = vector.X * factor;
            result.Y = vector.Y * factor;
            result.Z = vector.Z * factor;
        ...
        /// <param name="factor">The scaling factor by which to divide the vector.</param>
        /// <param name="result">The resulting <see cref="Vector4"/>.</param>
        public static void Divide(ref Vector4 vector, float factor, out Vector4 result)
        {
            result.X = vector.X / factor;
            result.Y = vector.Y / factor;
            result.Z = vector.Z / factor;
        ...
        public static void Lerp(ref Vector4 vector1, ref Vector4 vector2, float amount, out Vector4 result)
        {
            result.X = vector1.X + (vector2.X - vector1.X) * amount;
            result.Y = vector1.Y + (vector2.Y - vector1.Y) * amount;
            result.Z = vector1.Z + (vector2.Z - vector1.Z) * amount;
        ...
        /// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
        /// <param name="result">The interpolated <see cref="Vector4"/>.</param>
        public static void Hermite(ref Vector4 vector1, ref Vector4 tangent1, ref Vector4 vector2, ref Vector4 tangent2, float amount, out Vector4 result)
        {
            var t2 = amount * amount;
            var t3 = t2 * amount;
        ...
        /// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
        /// <param name="result">The interpolated <see cref="Vector4"/>.</param>
        public static void SmoothStep(ref Vector4 vector1, ref Vector4 vector2, float amount, out Vector4 result)
        {
			var amount;
            amount = amount > 1 ? 1 : amount < 0 ? 0 : amount;
            amount = amount * amount * (3.0f - 2.0f * amount);
        ...
        /// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
        /// <param name="result">The interpolated <see cref="Vector4"/>.</param>
        public static void CatmullRom(ref Vector4 vector1, ref Vector4 vector2, ref Vector4 vector3, ref Vector4 vector4, float amount, out Vector4 result)
        {
            var t2 = amount * amount;
            var t3 = t2 * amount;
        ...
        public static void Barycentric(ref Vector4 v1, ref Vector4 v2, ref Vector4 v3, float b2, float b3, out Vector4 result)
        {
            var b1 = (1 - b2 - b3);
        ...
        /// <inheritdoc/>
        public override void ToString(String outStr) => outStr.Append(scope $"{{X:{X} Y:{Y} Z:{Z} W:{W}}}");
