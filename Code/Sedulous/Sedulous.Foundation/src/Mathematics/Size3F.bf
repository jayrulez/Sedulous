...
namespace Sedulous.Foundation.Mathematics
{
    ...
    /// </summary>
    //[Serializable]
    public struct Size3F : IEquatable<Size3F>, IEquatable, IHashable, IInterpolatable<Size3F>
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public override void ToString(String outStr) => outStr.Append(scope $"{{Width:{Width} Height:{Height} Depth:{Depth}}}");
