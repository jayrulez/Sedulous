...
namespace Sedulous.Foundation.Mathematics
{
    ...
    /// </summary>
    //[Serializable]
    public struct RectangleF : IEquatable<RectangleF>, IEquatable, IHashable, IInterpolatable<RectangleF>
    {
        /// <summary>
        ...
        public static void Offset(ref RectangleF rectangle, float offsetX, float offsetY, out RectangleF result)
        {
            result.X = rectangle.X + offsetX;
            result.Y = rectangle.Y + offsetY;
            result.Width = rectangle.Width;
        ...
        public static void Inflate(ref RectangleF rectangle, float horizontalAmount, float verticalAmount, out RectangleF result)
        {
            result.X = rectangle.X - horizontalAmount;
            result.Y = rectangle.Y - verticalAmount;
            result.Width = rectangle.Width + (2 * horizontalAmount);
        ...
        /// <inheritdoc/>
        public override void ToString(String outStr) => outStr.Append(scope $"{{X:{X} Y:{Y}: Width:{Width} Height{Height}}}");
        ...
        public void Contains(ref Point2F point, out bool result)
        {
            result =
