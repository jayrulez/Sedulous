...
namespace Sedulous.Foundation.Mathematics
{
    ...
    /// </summary>
    //[Serializable]
    public struct Ray : IEquatable<Ray>, IEquatable, IHashable, IInterpolatable<Ray>
    {
        /// <summary>
        ...
        public void Intersects(ref BoundingSphere sphere, out float? result)
        {
            ...
            Vector3.Dot(ref Direction, ref offset, var distanceToCenter);
        ...
        /// <inheritdoc/>
        public override void ToString(String outStr) => outStr.Append(scope $"{{Position:{Position} Direction:{Direction}}}");
