...
namespace Sedulous.Foundation.Mathematics
{
    ...
    /// </summary>
    //[Serializable]
    public struct RectangleD : IEquatable<RectangleD>, IEquatable, IHashable, IInterpolatable<RectangleD>
    {
        /// <summary>
        ...
        public void Intersects(ref RectangleD rectangle, out bool result)
        {
            result =
                rectangle.Left < this.Right && 
                this.Left < rectangle.Right && 
        ...
        public void Contains(ref Point2D point, out bool result)
        {
            result =
        ...
        public void Contains(ref RectangleD rectangle, out bool result)
        {
            result = 
