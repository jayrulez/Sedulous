...
namespace Sedulous.Foundation.Mathematics
{
    ...
    /// </summary>
    //[Serializable]
    public struct Size2F : IEquatable<Size2F>, IEquatable, IHashable, IInterpolatable<Size2F>
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public override void ToString(String outStr) => outStr.Append(scope $"{{Width:{Width} Height:{Height}}}");
