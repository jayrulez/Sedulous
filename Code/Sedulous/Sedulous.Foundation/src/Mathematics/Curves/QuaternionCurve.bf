...
namespace Sedulous.Foundation.Mathematics
{
    ...
    public static class QuaternionCurve
    {
        ...
        public static Curve<Quaternion, CurveKey<Quaternion>> Step(CurveLoopType preLoop, CurveLoopType postLoop, Span<CurveKey<Quaternion>> keys) =>
        ...
        /// for points after the end of the curve.</param>
        /// <param name="keys">A collection of <see cref="CurveKey{float}"/> objects from which to construct the curve.</param>
        public static Curve<Quaternion, CurveKey<Quaternion>> Linear(CurveLoopType preLoop, CurveLoopType postLoop, Span<CurveKey<Quaternion>> keys) =>
        ...
        public static Curve<Quaternion, CubicSplineCurveKey<Quaternion>> CubicSpline(CurveLoopType preLoop, CurveLoopType postLoop, Span<CubicSplineCurveKey<Quaternion>> keys) =>
