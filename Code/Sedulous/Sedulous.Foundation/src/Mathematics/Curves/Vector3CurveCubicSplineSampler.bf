...
namespace Sedulous.Foundation.Mathematics
{
    ...
    public class Vector3CurveCubicSplineSampler : ICurveSampler<Vector3, CubicSplineCurveKey<Vector3>>
    {
        ...
        /// <inheritdoc/>
        public void CreateTemporaryValue(int elementCount, out Vector3 value) => value = default;

        /// <inheritdoc/>
        public void ReleaseTemporaryValue(in Vector3 value) { }

        /// <inheritdoc/>
        public Vector3 InterpolateKeyframes(CubicSplineCurveKey<Vector3> key1, CubicSplineCurveKey<Vector3> key2, float t, Vector3 offset, in Vector3 existing)
        {
            var t2 = t * t;
            var t3 = t2 * t;
        ...
        /// <inheritdoc/>
        public Vector3 CalculateLinearExtension(CubicSplineCurveKey<Vector3> key, float position, CurvePositionType positionType, in Vector3 existing)
        {
            switch (positionType)
            {
        ...
        /// </summary>
        public static Vector3CurveCubicSplineSampler Instance { get; } = new Vector3CurveCubicSplineSampler() ~ delete _;
    }
}
