...
namespace Sedulous.Foundation.Mathematics
{
    ...
    public static class Vector4Curve
    {
        ...
        public static Curve<Vector4, CurveKey<Vector4>> Step(CurveLoopType preLoop, CurveLoopType postLoop, Span<CurveKey<Vector4>> keys) =>
        ...
        /// for points after the end of the curve.</param>
        /// <param name="keys">A collection of <see cref="CurveKey{float}"/> objects from which to construct the curve.</param>
        public static Curve<Vector4, CurveKey<Vector4>> Linear(CurveLoopType preLoop, CurveLoopType postLoop, Span<CurveKey<Vector4>> keys) =>
        ...
        public static Curve<Vector4, CubicSplineCurveKey<Vector4>> CubicSpline(CurveLoopType preLoop, CurveLoopType postLoop, Span<CubicSplineCurveKey<Vector4>> keys) =>
