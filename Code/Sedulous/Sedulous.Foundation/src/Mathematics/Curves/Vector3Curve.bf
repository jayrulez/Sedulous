...
namespace Sedulous.Foundation.Mathematics
{
    ...
    public static class Vector3Curve
    {
        ...
        public static Curve<Vector3, CurveKey<Vector3>> Step(CurveLoopType preLoop, CurveLoopType postLoop, Span<CurveKey<Vector3>> keys) =>
        ...
        /// for points after the end of the curve.</param>
        /// <param name="keys">A collection of <see cref="CurveKey{float}"/> objects from which to construct the curve.</param>
        public static Curve<Vector3, CurveKey<Vector3>> Linear(CurveLoopType preLoop, CurveLoopType postLoop, Span<CurveKey<Vector3>> keys) =>
        ...
        public static Curve<Vector3, CubicSplineCurveKey<Vector3>> CubicSpline(CurveLoopType preLoop, CurveLoopType postLoop, Span<CubicSplineCurveKey<Vector3>> keys) =>
