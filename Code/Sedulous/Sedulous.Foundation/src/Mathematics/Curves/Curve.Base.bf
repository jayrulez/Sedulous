...
namespace Sedulous.Foundation.Mathematics
{
    ...
    public abstract class Curve<TValue>
    {
        ...
        public this(CurveLoopType preLoop, CurveLoopType postLoop)
        {
        ...
        public abstract TValue Evaluate(float position, in TValue existing);
        ...
        /// </summary>
        public abstract float StartPosition { get; protected set; }

        /// <summary>
        /// Gets the curve's ending position.
        /// </summary>
        public abstract float EndPosition { get; protected set; }
