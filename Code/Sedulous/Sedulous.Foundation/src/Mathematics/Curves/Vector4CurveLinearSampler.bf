...
namespace Sedulous.Foundation.Mathematics
{
    ...
    public class Vector4CurveLinearSampler : ICurveSampler<Vector4, CurveKey<Vector4>>
    {
        ...
        /// <inheritdoc/>
        public Vector4 InterpolateKeyframes(CurveKey<Vector4> key1, CurveKey<Vector4> key2, float t, Vector4 offset, in Vector4 existing)
        {
        ...
        /// <inheritdoc/>
        public Vector4 CalculateLinearExtension(CurveKey<Vector4> key, float position, CurvePositionType positionType, in Vector4 existing) =>
            key.Value;
        ...
        /// </summary>
        public static Vector4CurveLinearSampler Instance { get; } = new Vector4CurveLinearSampler() ~ delete _;
    }
}
