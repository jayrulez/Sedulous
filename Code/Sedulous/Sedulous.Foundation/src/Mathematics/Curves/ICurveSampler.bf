...
namespace Sedulous.Foundation.Mathematics
{
    ...
    public interface ICurveSampler<TValue, TKey>
        where TKey : CurveKey<TValue>
    {
        ...
        void CreateTemporaryValue(int elementCount, out TValue value);
        ...
        TValue InterpolateKeyframes(TKey key1, TKey key2, float t, TValue offset, in TValue existing);
        ...
        TValue CalculateLinearExtension(TKey key, float position, CurvePositionType positionType, in TValue existing);
