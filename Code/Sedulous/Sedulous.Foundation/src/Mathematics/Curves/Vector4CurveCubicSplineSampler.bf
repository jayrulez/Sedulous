...
namespace Sedulous.Foundation.Mathematics
{
    ...
    public class Vector4CurveCubicSplineSampler : ICurveSampler<Vector4, CubicSplineCurveKey<Vector4>>
    {
        ...
        /// <inheritdoc/>
        public void CreateTemporaryValue(int elementCount, out Vector4 value) => value = default;

        /// <inheritdoc/>
        public void ReleaseTemporaryValue(in Vector4 value) { }

        /// <inheritdoc/>
        public Vector4 InterpolateKeyframes(CubicSplineCurveKey<Vector4> key1, CubicSplineCurveKey<Vector4> key2, float t, Vector4 offset, in Vector4 existing)
        {
            var t2 = t * t;
            var t3 = t2 * t;
        ...
        /// <inheritdoc/>
        public Vector4 CalculateLinearExtension(CubicSplineCurveKey<Vector4> key, float position, CurvePositionType positionType, in Vector4 existing)
        {
            switch (positionType)
            {
        ...
        /// </summary>
        public static Vector4CurveCubicSplineSampler Instance { get; } = new Vector4CurveCubicSplineSampler() ~ delete _;
    }
}
