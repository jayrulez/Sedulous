...
namespace Sedulous.Foundation.Mathematics
{
    ...
    public class QuaternionCurveCubicSplineSampler : ICurveSampler<Quaternion, CubicSplineCurveKey<Quaternion>>
    {
        ...
        /// <inheritdoc/>
        public Quaternion InterpolateKeyframes(CubicSplineCurveKey<Quaternion> key1, CubicSplineCurveKey<Quaternion> key2, float t, Quaternion offset, in Quaternion existing)
        {
            var t2 = t * t;
            var t3 = t2 * t;
        ...
        /// <inheritdoc/>
        public Quaternion CalculateLinearExtension(CubicSplineCurveKey<Quaternion> key, float position, CurvePositionType positionType, in Quaternion existing)
        {
            switch (positionType)
            {
        ...
        /// </summary>
        public static QuaternionCurveCubicSplineSampler Instance { get; } = new QuaternionCurveCubicSplineSampler() ~ delete _;
    }
}
