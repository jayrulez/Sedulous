...
namespace Sedulous.Foundation.Mathematics
{
    ...
    public static class Vector2Curve
    {
        ...
        public static Curve<Vector2, CurveKey<Vector2>> Step(CurveLoopType preLoop, CurveLoopType postLoop, Span<CurveKey<Vector2>> keys) =>
        ...
        /// for points after the end of the curve.</param>
        /// <param name="keys">A collection of <see cref="CurveKey{float}"/> objects from which to construct the curve.</param>
        public static Curve<Vector2, CurveKey<Vector2>> Linear(CurveLoopType preLoop, CurveLoopType postLoop, Span<CurveKey<Vector2>> keys) =>
        ...
        public static Curve<Vector2, CubicSplineCurveKey<Vector2>> CubicSpline(CurveLoopType preLoop, CurveLoopType postLoop, Span<CubicSplineCurveKey<Vector2>> keys) =>
