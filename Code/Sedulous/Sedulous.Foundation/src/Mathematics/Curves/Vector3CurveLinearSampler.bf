...
namespace Sedulous.Foundation.Mathematics
{
    ...
    public class Vector3CurveLinearSampler : ICurveSampler<Vector3, CurveKey<Vector3>>
    {
        ...
        /// <inheritdoc/>
        public Vector3 InterpolateKeyframes(CurveKey<Vector3> key1, CurveKey<Vector3> key2, float t, Vector3 offset, in Vector3 existing)
        {
        ...
        /// <inheritdoc/>
        public Vector3 CalculateLinearExtension(CurveKey<Vector3> key, float position, CurvePositionType positionType, in Vector3 existing) =>
            key.Value;
        ...
        /// </summary>
        public static Vector3CurveLinearSampler Instance { get; } = new Vector3CurveLinearSampler() ~ delete _;
    }
}
