...
namespace Sedulous.Foundation.Mathematics
{
    ...
    /// </summary>
    //[Serializable]
    public struct Quaternion : IEquatable<Quaternion>, IEquatable, IHashable, IInterpolatable<Quaternion>
    {
        /// <summary>
        ...
        /// <param name="factor">The scaling factor by which to multiply the quaternion.</param>
        /// <param name="result">The resulting <see cref="Quaternion"/>.</param>
        public static void Multiply(ref Quaternion quaternion, float factor, out Quaternion result)
        {
            result.X = quaternion.X * factor;
            result.Y = quaternion.Y * factor;
            result.Z = quaternion.Z * factor;
        ...
        public Quaternion Interpolate(Quaternion target, float t)
        {
			var self = this;
			var target;
            Slerp(ref self, ref target, t, var result);
            return result;
        }
