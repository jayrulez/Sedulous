...
namespace Sedulous.Foundation.Mathematics
{
    ...
    /// </summary>
    //[Serializable]
    public struct Vector3 : IEquatable<Vector3>, IEquatable, IHashable, IInterpolatable<Vector3>
    {
        /// <summary>
        ...
        /// <param name="factor">The scaling factor by which to multiply the vector.</param>
        /// <param name="result">The resulting <see cref="Vector3"/>.</param>
        public static void Multiply(ref Vector3 vector, float factor, out Vector3 result)
        {
            result.X = vector.X * factor;
            result.Y = vector.Y * factor;
            result.Z = vector.Z * factor;
        ...
        /// <param name="factor">The scaling factor by which to divide the vector.</param>
        /// <param name="result">The resulting <see cref="Vector3"/>.</param>
        public static void Divide(ref Vector3 vector, float factor, out Vector3 result)
        {
            result.X = vector.X / factor;
            result.Y = vector.Y / factor;
            result.Z = vector.Z / factor;
        ...
        public static void Lerp(ref Vector3 vector1, ref Vector3 vector2, float amount, out Vector3 result)
        {
            result.X = vector1.X + (vector2.X - vector1.X) * amount;
            result.Y = vector1.Y + (vector2.Y - vector1.Y) * amount;
            result.Z = vector1.Z + (vector2.Z - vector1.Z) * amount;            
        ...
        public static void Hermite(ref Vector3 vector1, ref Vector3 tangent1, ref Vector3 vector2, ref Vector3 tangent2, float amount, out Vector3 result)
        {
            var t2 = amount * amount;
            var t3 = t2 * amount;
        ...
        /// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
        /// <param name="result">The interpolated <see cref="Vector3"/>.</param>
        public static void SmoothStep(ref Vector3 vector1, ref Vector3 vector2, float amount, out Vector3 result)
        {
			var amount;
            amount = amount > 1 ? 1 : amount < 0 ? 0 : amount;
            amount = amount * amount * (3.0f - 2.0f * amount);
        ...
        /// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
        /// <param name="result">The interpolated <see cref="Vector3"/>.</param>
        public static void CatmullRom(ref Vector3 vector1, ref Vector3 vector2, ref Vector3 vector3, ref Vector3 vector4, float amount, out Vector3 result)
        {
            var t2 = amount * amount;
            var t3 = t2 * amount;
        ...
        public static void Barycentric(ref Vector3 v1, ref Vector3 v2, ref Vector3 v3, float b2, float b3, out Vector3 result)
        {
            var b1 = (1 - b2 - b3);
        ...
        /// <inheritdoc/>
        public override void ToString(String outStr) => outStr.Append(scope $"{{X:{X} Y:{Y} Z:{Z}}}");
