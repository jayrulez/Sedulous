...
namespace Sedulous.Foundation.Mathematics
{
    ...
    /// </summary>
    //[Serializable]
    public struct Circle : IEquatable<Circle>, IEquatable, IHashable, IInterpolatable<Circle>
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public override void ToString(String outStr) => outStr.Append(scope $"{{Position:{Position} Radius:{Radius}}}");
