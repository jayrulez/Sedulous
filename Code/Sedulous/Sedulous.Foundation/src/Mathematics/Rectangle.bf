...
namespace Sedulous.Foundation.Mathematics
{
    ...
    /// </summary>
    //[Serializable]
    public struct Rectangle : IEquatable<Rectangle>, IEquatable, IHashable, IInterpolatable<Rectangle>
    {
        /// <summary>
        ...
        public void Intersects(ref Rectangle rectangle, out bool result)
        {
            result =
                rectangle.Left < this.Right && 
                this.Left < rectangle.Right && 
        ...
        public void Contains(ref Point2 point, out bool result)
        {
            result =
