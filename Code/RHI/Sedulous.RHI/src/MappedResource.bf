...
struct MappedResource
{
	...
	/// <summary>
	/// For <see cref="T:Sedulous.RHI.Texture" /> resources, this is the subresource which is mapped.
	...
	/// <summary>
	/// For <see cref="T:Sedulous.RHI.Texture" /> resources, this is the number of bytes between each slice of a 3D texture.
	/// For <see cref="T:Sedulous.RHI.Buffer" /> resources, this field has no meaning.
	/// </summary>
